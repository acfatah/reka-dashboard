  ...
  <Card>
    ...
    <CardContent class="pb-4">
      <div class="h-[200px]">
        ...
        >
          <VisTooltip />
          <VisLine :x="x" :y="[(d: Data) => d.average, (d: Data) => d.today]" :stroke-width="2" color="var(--primary)" :attributes="{ [Line.selectors.linePath]: { opacity: computeLineOpacity } }" />
          <VisScatter :x="x" :y="[(d: Data) => d.average, (d: Data) => d.today]" :size="6" :stroke-width="2" stroke-color="var(--primary)" color="white" />
