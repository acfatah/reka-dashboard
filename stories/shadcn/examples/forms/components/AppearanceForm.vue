...
const appearanceFormSchema = toTypedSchema(schema)
...
const onSubmit: SubmissionHandler<GenericObject> = function (values) {
  const formValues = values as AppearanceRecord
      ...
      <FormItem>
        ...
        <div class="relative w-[200px]">
          ...
          <Icon
            ...
            class="pointer-events-none absolute right-3 top-2.5 opacity-50"
            width="16"
            height="16"
          />
        </div>
