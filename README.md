...
<p>
  <a href="https://github.com/acfatah/bun-vue/commits/tailwind">
  <img alt="GitHub last commit (by committer)" src="https://img.shields.io/github/last-commit/acfatah/bun-vue/tailwind?display_timestamp=committer&style=flat-square"></a>
</p>

Opinionated Vue Application Boilerplate.

This template should help you get started with developing a Vue 3 application with Tailwindcss in TypeScript and Vite using Bun.
...
- A utility-first, [Tailwindcss](https://tailwindcss.com).
...
```bash
bunx tiged acfatah/bun-vue#tailwindcss
```
